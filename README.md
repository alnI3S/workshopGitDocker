# Atelier pratique: Maîtriser Git, Docker et VSCode sous Ubuntu

Support pour le workshop du 14 Octobre 2025.

Découvrez comment configurer un **environnement de développement reproductible et efficace** en combinant **Git, Docker** et **Visual Studio Code (VSCode)** sous Ubuntu. Cet atelier est conçu pour les **développeurs débutants et intermédiaires** souhaitant optimiser leur workflow et gagner en productivité.
# Objectifs
